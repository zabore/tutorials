...
Use Hadley Wickham's great package `pkgdown` to easily build a website from your package. Details of `pkgdown` can be found on [the pkgdown website](http://pkgdown.r-lib.org/), which was created using `pkgdown`.
