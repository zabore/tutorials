...
An example from the [website](http://www.emilyzabor.net/ezfun/) for my package `ezfun`:
...
You can create a website for a non-package repository as well. For example, I have [a page](http://www.emilyzabor.net/tutorials/) on my website linking to the repository in which this tutorial is stored.
