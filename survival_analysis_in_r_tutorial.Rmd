...
3. "lat_status": Character variable denoting whether the patient is alive, and the cause of death if dead
...
We see this is a character variable in a certain format, but we need it to be a 
